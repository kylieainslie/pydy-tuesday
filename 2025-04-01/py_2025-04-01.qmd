...
A supplemental [data source](https://gist.github.com/EmilHvitfeldt/b6773de4c00426c1c80e1b578cd50546) on the evolution of Pokemon is sourced from [Emil Hvitfeldt](https://gist.github.com/EmilHvitfeldt).

### Data Details
The `pokemon` package provides a dataset of Pokemon information in both English and Brazilian Portuguese. The dataset contains 949 rows and 22 columns, including information such as the Pokemon’s name, ID, height, weight, stats, type, and more.

The `evolutiions.csv` file created my Emil Hvitfeldt contains information on the evolutionary stage and family of each Pokemon.
...
def add_image(ax, img_path, x, y, zoom=0.01):
